...
export default async function AnalyticsPage({
  ...
  if (!actor.userId) {
    return (
      <main className="mx-auto max-w-3xl p-6">
        ...
        <p className="mt-2 text-sm text-zinc-600">Please sign in to access analytics.</p>
      </main>
    );
  }
  ...
  if (!isSubscriber) {
    return (
      <main className="mx-auto max-w-3xl p-6">
        <h1 className="text-2xl font-bold">Analytics (Subscriber Feature)</h1>
        <p className="mt-2 text-sm text-zinc-600">
          This analytics module is available for paid subscribers. Ask an admin to enable analytics for your company.
        </p>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-[calc(100vh-3.5rem)] bg-zinc-100 p-3 text-zinc-900 sm:p-4">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <form method="get" action="/analytics" className="mt-5 rounded-lg border bg-white p-4">
